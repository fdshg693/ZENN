...
> 参考: [Cosmos DB Overview](https://learn.microsoft.com/en-us/azure/cosmos-db/overview), [Choose an API](https://learn.microsoft.com/en-us/azure/cosmos-db/choose-api), [Distribute Data Globally](https://learn.microsoft.com/en-us/azure/cosmos-db/distribute-data-globally)
...
> 参考: [Set Throughput on Database and Container](https://learn.microsoft.com/en-us/azure/cosmos-db/set-throughput), [Optimize Cost with Throughput](https://learn.microsoft.com/en-us/azure/cosmos-db/optimize-cost-throughput), [Serverless multi-tenant models](https://learn.microsoft.com/en-us/azure/cosmos-db/serverless)
...
> 参考: [concepts-limits](https://learn.microsoft.com/en-us/azure/cosmos-db/concepts-limits)
...
> 参考: [FAQ (ETag / OCC)](https://learn.microsoft.com/en-us/azure/cosmos-db/faq), [Model Partition Example](https://learn.microsoft.com/en-us/azure/cosmos-db/nosql/model-partition-example)
...
> 参考: [Optimize Cost for Reads and Writes](https://learn.microsoft.com/en-us/azure/cosmos-db/optimize-cost-reads-writes), [Q&A: Point read vs query RU](https://learn.microsoft.com/en-us/answers/questions/1193016/point-read-has-higher-rus-than-equivalent-query)
...
> 参考: [Indexing Policies](https://learn.microsoft.com/en-us/azure/cosmos-db/index-policy), [Sample Indexing Policies](https://learn.microsoft.com/en-us/cosmos-db/sample-indexing-policies)
...
> 参考: [Indexing Policies](https://learn.microsoft.com/en-us/azure/cosmos-db/index-policy), [Sample Indexing Policies](https://learn.microsoft.com/en-us/cosmos-db/sample-indexing-policies), [Troubleshoot Query Performance](https://learn.microsoft.com/en-us/azure/cosmos-db/troubleshoot-query-performance)
...
> 参考: [request-units](https://learn.microsoft.com/en-us/azure/cosmos-db/request-units)
...
> 参考: [throughput-serverless](https://learn.microsoft.com/en-us/azure/cosmos-db/throughput-serverless), [how-to-choose-offer](https://learn.microsoft.com/en-us/azure/cosmos-db/how-to-choose-offer), [autoscale-faq](https://learn.microsoft.com/en-us/azure/cosmos-db/autoscale-faq), [free-tier](https://learn.microsoft.com/en-us/azure/cosmos-db/free-tier)
...
> 参考: [consistency-levels](https://learn.microsoft.com/en-us/azure/cosmos-db/consistency-levels)
...
> 参考: [partitioning-overview](https://learn.microsoft.com/en-us/azure/cosmos-db/partitioning-overview), [partitioning](https://learn.microsoft.com/en-us/azure/cosmos-db/partitioning)
...
> 参考: [hierarchical-partition-keys](https://learn.microsoft.com/en-us/azure/cosmos-db/hierarchical-partition-keys)
...
> 参考: [model-partition-example](https://learn.microsoft.com/en-us/azure/cosmos-db/nosql/model-partition-example)
...
> 参考: [change-feed](https://learn.microsoft.com/en-us/azure/cosmos-db/change-feed), [Functions Cosmos DB trigger](https://learn.microsoft.com/en-us/azure/azure-functions/functions-bindings-cosmosdb-v2-trigger), [change-feed-design-patterns](https://learn.microsoft.com/en-us/azure/cosmos-db/change-feed-design-patterns)
...
> 参考: [transactional outbox pattern for cosmos](https://learn.microsoft.com/en-us/azure/architecture/databases/guide/transactional-out-box-cosmos)
...
> 参考: [synapse-link](https://learn.microsoft.com/en-us/azure/cosmos-db/synapse-link), [configure synapse link](https://learn.microsoft.com/en-us/azure/cosmos-db/configure-synapse-link)
...
> 参考: [vector-search-overview](https://learn.microsoft.com/en-us/azure/cosmos-db/gen-ai/vector-search-overview), [RAG](https://learn.microsoft.com/en-us/azure/cosmos-db/gen-ai/rag), [vector-database](https://learn.microsoft.com/en-us/azure/cosmos-db/vector-database)
...
> 参考: [event-sourcing sample](https://learn.microsoft.com/en-us/samples/azure-samples/cosmos-db-design-patterns/event-sourcing/)
...
> 参考: [change-feed-design-patterns](https://learn.microsoft.com/en-us/azure/cosmos-db/change-feed-design-patterns)
...
> 参考: [cosmos-db-design-patterns (GitHub)](https://github.com/Azure-Samples/cosmos-db-design-patterns), [minimize-coordination](https://learn.microsoft.com/en-us/azure/architecture/guide/design-principles/minimize-coordination)
...
> 参考: [troubleshoot-query-performance](https://learn.microsoft.com/en-us/azure/cosmos-db/troubleshoot-query-performance), [concepts-limits](https://learn.microsoft.com/en-us/azure/cosmos-db/concepts-limits), [reliability-cosmos-db-nosql](https://learn.microsoft.com/en-us/azure/reliability/reliability-cosmos-db-nosql)
